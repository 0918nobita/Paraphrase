...
static NoParamErrorMessageDict gNoParamErrorMessageDict {
	{ NoParamErrorID::E_SYSTEM_ERROR, {
		{ PPLang::EN,	"SYSTEM ERROR." },
		{ PPLang::JP,	"システムエラー。" },
	  }
	},

	{ NoParamErrorID::E_ILLEGAL_LVOP, {
		{ PPLang::EN,	"Illegal LVOP." },
		{ PPLang::JP,	"不正な LVOP です" },
	  }
	},

	{ NoParamErrorID::E_SHOULD_BE_EXECUTED_IN_DEFINITION, {
	...
	{ NoParamErrorID::E_HERE_DOCUMENT_MISMATCH, {
	...
	{ NoParamErrorID::E_CAN_NOT_CONVERT_TO_INT, {
		{ PPLang::EN,	"can not convert to int value." },
		{ PPLang::JP,	"整数値へ変換できません。" },
	  }
	},
	{ NoParamErrorID::E_CAN_NOT_CONVERT_TO_INT_DUE_TO_OVERFLOW, {
		{ PPLang::EN,	"can not convert to int due to overflow." },
		{ PPLang::JP,	"オーバーフローのため int に変換できません。" },
	  }
	},
	{ NoParamErrorID::E_CAN_NOT_CONVERT_TO_LONG_DUE_TO_OVERFLOW, {
	...
	{ NoParamErrorID::E_REGEX_BADREPEAT, {
	...
	{ NoParamErrorID::E_REGEX_COMPLEXITY, {
	...
	{ NoParamErrorID::E_SYNTAX_MISMATCH_WHILE, {
		{ PPLang::EN,	"syntax mismatch. "
	...
	{ NoParamErrorID::E_SYNTAX_MISMATCH_LOOP, {
		{ PPLang::EN,	"syntax mismatch. "
	...
	{ NoParamErrorID::E_SYNTAX_MISMATCH_SWITCH, {
		{ PPLang::EN,	"syntax mismatch. "
	...
	{ NoParamErrorID::E_SYNTAX_MISMATCH_LEAVABLE_LOOP_GROUP, {
		{ PPLang::EN,	"syntax mismatch. "
...
static InvalidTypeErrorMessageDict gInvalidTypeErrorMessageDict {
	...
	{ InvalidTypeErrorID::E_TOS_INT_OR_LONG, {
	...
	{ InvalidTypeErrorID::E_TOS_INT_OR_LONG_OR_BIGINT, {
	...
	{ InvalidTypeErrorID::E_TOS_DOUBLABLE, {
	...
	{ InvalidTypeErrorID::E_TOS_NUMBER, {
	...
	{ InvalidTypeErrorID::E_TOS_STRING, {
	...
	{ InvalidTypeErrorID::E_TOS_STRING_OR_WORD, {
	...
	{ InvalidTypeErrorID::E_TOS_SYMBOL, {
	...
	{ InvalidTypeErrorID::E_TOS_SYMBOL_OR_LIST, {
	...
	{ InvalidTypeErrorID::E_TOS_ARRAY, {
	...
	{ InvalidTypeErrorID::E_TOS_ARRAY_OR_LIST, {
	...
	{ InvalidTypeErrorID::E_TOS_ARRAY_OR_LIST_OR_STRING_OR_SYMBOL, {
	...
	{ InvalidTypeErrorID::E_TOS_BOOL_OR_WP, {
	...
	{ InvalidTypeErrorID::E_TOS_NUMBER_OR_STRING, {
	...
	{ InvalidTypeErrorID::E_TOS_WP_OR_STDCODE, {
	...
	{ InvalidTypeErrorID::E_TOS_ADDRESS, {
	...
	{ InvalidTypeErrorID::E_TOS_PARAMDEST, {
	...
	{ InvalidTypeErrorID::E_TOS_NEW_WORD, {
	...
	{ InvalidTypeErrorID::E_TOS_WP_OR_NW, {
	...
	{ InvalidTypeErrorID::E_TOS_WP_OR_STRING, {
		{ PPLang::EN,	"TOS should be a word pointer or a string. "
						"Current TOS type is %s." },
		{ PPLang::JP,	"TOS がワードもしくは文字列ではありません。"
						"現在の TOS は %s です。" },
	  }
	},
	{ InvalidTypeErrorID::E_TOS_STDCODE, {
	...
	{ InvalidTypeErrorID::E_SECOND_INT, {
	...
	{ InvalidTypeErrorID::E_SECOND_INT_OR_LONG_OR_BIGINT, {
	...
	{ InvalidTypeErrorID::E_SECOND_BOOL, {
	...
	{ InvalidTypeErrorID::E_SECOND_STRING, {
	...
	{ InvalidTypeErrorID::E_SECOND_ARRAY, {
	...
	{ InvalidTypeErrorID::E_SECOND_LIST, {
	...
	{ InvalidTypeErrorID::E_SECOND_KV, {
	...
	{ InvalidTypeErrorID::E_SECOND_ARRAY_OR_LIST, {
	...
	{ InvalidTypeErrorID::E_SECOND_ARRAY_OR_LIST_OR_KV, {
		{ PPLang::EN,	"The second should be an array or a list "
	...
	{ InvalidTypeErrorID::E_SECOND_FILE, {
	...
	{ InvalidTypeErrorID::E_SECOND_BOOL_OR_WP, {
	...
	{ InvalidTypeErrorID::E_SECOND_THRESHOLD, {
	...
	{ InvalidTypeErrorID::E_SECOND_WP, {
	...
	{ InvalidTypeErrorID::E_THIRD_BOOL, {
	...
	{ InvalidTypeErrorID::E_THIRD_LIST, {
		{ PPLang::EN,	"The third should be an a list."
						"Current Third type is %s." },
		{ PPLang::JP,	"スタックの 3 番目の要素がリストではありません。"
						"現在の 3 番目の要素は %s です。" },
	  }
	},
	{ InvalidTypeErrorID::E_THIRD_ARRAY_OR_LIST_OR_KV, {
	...
	{ InvalidTypeErrorID::E_RS_TOS_ADDRESS, {
	...
	{ InvalidTypeErrorID::E_RS_TOS_THRESHOLD, {
	...
	{ InvalidTypeErrorID::E_RS_SECOND_INT_OR_LONG_OR_BIGINT, {
	...
	{ InvalidTypeErrorID::E_RS_SECOND_WP, {
	...
	{ InvalidTypeErrorID::E_SS_MISCINT, {
	...
	{ InvalidTypeErrorID::E_SS_TOS_SHOULD_BE_LOOP, {
	...
	{ InvalidTypeErrorID::E_TOS_CAN_NOT_CONVERT_TO_DOUBLE, {
	...
	{ InvalidTypeErrorID::E_TOS_CAN_NOT_CONVERT_TO_FLOAT, {
	...
	{ InvalidTypeErrorID::E_FIRST_ELEMENT_STRING, {
	...
	{ InvalidTypeErrorID::E_LV_NUMBER, {
...
static InvalidValueErrorMessageDict gInvalidValueErrorMessageDict {
	{ InvalidValueErrorID::E_TOS_NO_SUCH_A_KEY, {
...
static InvalidTypeTosSecondErrorMessageDict gInvalidTypeTosSecondErrorMessageDict {
	{ InvalidTypeTosSecondErrorID::E_INVALID_DATA_TYPE_TOS_SECOND, {
	...
	{ InvalidTypeTosSecondErrorID::E_OUT_OF_SUPPORT_TOS_SECOND, {
...
static InvalidTypeStrTvTvErrorMessageDict gInvalidTypeStrTvTvErrorMessageDict {
	{ InvalidTypeStrTvTvErrorID::E_INVALID_DATA_TYPE_FOR_OP, {
...
static ErrorWithStringMessageDict gErrorWithStringMessageDict {
	...
	{ ErrorIdWithString::E_CAN_NOT_MAKE_SHORTEN_NAME_UNOVERWRITABLE, {
	...
	{ ErrorIdWithString::E_AMBIGOUS_WORD_NAME, {
...
static ErrorWithIntMessageDict gErrorWithIntMessageDict {
	{ ErrorIdWithInt::E_TOS_POSITIVE_INT, {
	...
	{ ErrorIdWithInt::E_SECOND_POSITIVE_INT, {
	...
	{ ErrorIdWithInt::E_TOS_NON_NEGATIVE, {
	...
	{ ErrorIdWithInt::E_SECOND_NON_NEGATIVE, {
	...
	{ ErrorIdWithInt::E_INVALID_LOCAL_SLOT_INDEX, {
...
static ErrorWith2IntMessageDict gErrorWith2IntMessageDict {
	{ ErrorIdWith2int::E_DS_NOT_ENOUGH_DATA, {
	...
	{ ErrorIdWith2int::E_DEPTH_INDEX_OUT_OF_RANGE, {
	...
	{ ErrorIdWith2int::E_STRING_INDEX_OUT_OF_RANGE, {
	...
	{ ErrorIdWith2int::E_ARRAY_INDEX_OUT_OF_RANGE, {
		{ PPLang::EN,	"index is out of range.\n"
	...
	{ ErrorIdWith2int::E_LIST_INDEX_OUT_OF_RANGE, {
		{ PPLang::EN,	"index is out of range.\n"
	...
	{ ErrorIdWith2int::E_LIST_START_INDEX_OUT_OF_RANGE, {
	...
	{ ErrorIdWith2int::E_LIST_LENGTH_INDEX_OUT_OF_RANGE, {
